...
import BranchCoverageTest.BinarySearch;
...
public class Exo3Test {
    ...
    void Exotest() {
        ...
        assertEquals(3, BranchCoverageTest.BinarySearch.binarySearch_corected(tab, 3)); // Test BinarySearch method with tab array
    }
    ...
    public void testBinarySearchWithNullArray() {
        ...
        assertThrows(NullPointerException.class, () -> {
            BranchCoverageTest.BinarySearch.binarySearch_corected(array, 5);
        });
    }
